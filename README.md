...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hxy5ulm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hxy5ulm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Daviesd8/container-hxy5ulm.git
cd container-hxy5ulm
```
...
```
docker attach container-hxy5ulm
```
